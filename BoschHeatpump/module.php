...
class BoschHeatpump extends IPSModuleStrict
{
    ...
    const THERMOSTAT_ENTITIES = [
        ...
        'T_HK1Solareinfluss'         => ['HK1 Solareinfluss',                    VARIABLETYPE_FLOAT,   '~Temperature.1',    true,  'hc1solarinfl',        'HK1 Temperaturen'],
        'T_HK1AktSolareinfluss'      => ['HK1 akt. Solareinfluss',              VARIABLETYPE_FLOAT,   '~Temperature.1',    false, 'hc1actualsolarinfl',  'HK1 Temperaturen'],
