<?php
/**
 * Bosch Wärmepumpe / EMS-ESP Modul für IP-Symcon
 * Alle Entitäten aus EMS-ESP (Boiler + Thermostat)
 * @version 2.0.0
 */
...
{
    // =========================================================================
    // Alle Boiler-Entitäten: Ident => [Name, Typ, Profil, Schreibbar, EMS-Key, Kategorie]
    // =========================================================================
    const BOILER_ENTITIES = [
        ...
        'B_KompressorAktivitaet'    => ['Kompressoraktivität',                  VARIABLETYPE_STRING,  '',                  false, 'hpActivity',          'Status'],
        ...
        // --- Temperaturen ---
        'B_Aussentemperatur'        => ['Außentemperatur',                      VARIABLETYPE_FLOAT,   '~Temperature',      false, 'outdoortemp',         'Temperaturen'],
        'B_VorlaufAktuell'          => ['Aktuelle Vorlauftemperatur',           VARIABLETYPE_FLOAT,   '~Temperature',      false, 'curflowtemp',         'Temperaturen'],
        'B_Ruecklauftemperatur'     => ['Rücklauftemperatur',                   VARIABLETYPE_FLOAT,   '~Temperature',      false, 'rettemp',             'Temperaturen'],
        'B_HydrWeiche'              => ['Hydr. Weiche',                         VARIABLETYPE_FLOAT,   '~Temperature',      false, 'mixertemp',           'Temperaturen'],
        'B_VorlaufGewaehlt'         => ['Gewählte Vorlauftemperatur',           VARIABLETYPE_FLOAT,   '~Temperature',      true,  'selflowtemp',         'Temperaturen'],
        ...
        // --- Kältemittel & WP-Temperaturen ---
        'B_TC0'                     => ['Kältemittelrücklauf (TC0)',            VARIABLETYPE_FLOAT,   '~Temperature',      false, 'tc0',                 'Kältekreis'],
        'B_TC1'                     => ['Kältemittelvorlauf (TC1)',             VARIABLETYPE_FLOAT,   '~Temperature',      false, 'tc1',                 'Kältekreis'],
        'B_TC3'                     => ['Kondensatortemperatur (TC3)',          VARIABLETYPE_FLOAT,   '~Temperature',      false, 'tc3',                 'Kältekreis'],
        'B_TR1'                     => ['Kompressortemperatur (TR1)',           VARIABLETYPE_FLOAT,   '~Temperature',      false, 'tr1',                 'Kältekreis'],
        'B_TR3'                     => ['Kältemittel flüssig (TR3)',            VARIABLETYPE_FLOAT,   '~Temperature',      false, 'tr3',                 'Kältekreis'],
        'B_TR4'                     => ['Verdampfereingang (TR4)',              VARIABLETYPE_FLOAT,   '~Temperature',      false, 'tr4',                 'Kältekreis'],
        'B_TR5'                     => ['Kompressoreingang (TR5)',              VARIABLETYPE_FLOAT,   '~Temperature',      false, 'tr5',                 'Kältekreis'],
        'B_TR6'                     => ['Kompressorausgang (TR6)',              VARIABLETYPE_FLOAT,   '~Temperature',      false, 'tr6',                 'Kältekreis'],
        'B_TR7'                     => ['Kältemittel gasförmig (TR7)',          VARIABLETYPE_FLOAT,   '~Temperature',      false, 'tr7',                 'Kältekreis'],
        'B_TL2'                     => ['Außenlufteintritt (TL2)',              VARIABLETYPE_FLOAT,   '~Temperature',      false, 'tl2',                 'Kältekreis'],
        'B_PL1'                     => ['Niederdrucktemperatur (PL1)',          VARIABLETYPE_FLOAT,   '~Temperature',      false, 'pl1',                 'Kältekreis'],
        'B_PH1'                     => ['Hochdrucktemperatur (PH1)',            VARIABLETYPE_FLOAT,   '~Temperature',      false, 'ph1',                 'Kältekreis'],
        'B_TA4'                     => ['Kondensatorwanne (TA4)',               VARIABLETYPE_FLOAT,   '~Temperature',      false, 'ta4',                 'Kältekreis'],
        'B_SoleIn'                  => ['Sole in / Verdampfer',                 VARIABLETYPE_FLOAT,   '~Temperature',      false, 'hpSourceIn',          'Kältekreis'],
        'B_SoleAus'                 => ['Sole aus / Kondensator',               VARIABLETYPE_FLOAT,   '~Temperature',      false, 'hpSourceOut',         'Kältekreis'],
        ...
        'B_BetriebszeitKompKuehlen' => ['Betriebszeit Kompressor Kühlen',       VARIABLETYPE_FLOAT,   'BHP.Hours',         false, 'hpCompCoolTime',      'Betriebszeiten'],
        ...
        'B_KuehlbetriebStarts'      => ['Kühlregelungstarts',                   VARIABLETYPE_INTEGER, '',                  false, 'hpCoolStarts',        'Betriebszeiten'],
        ...
        // --- Energie Abgabe (Wärme) ---
        'B_GesamtEnergie'           => ['Gesamtenergie (Wärme)',                VARIABLETYPE_FLOAT,   'BHP.kWh',           false, 'nrgTotal',            'Energie Abgabe'],
        'B_WWKEnergie'              => ['WWK Energie (Wärme)',                  VARIABLETYPE_FLOAT,   'BHP.kWh',           false, 'nrgWw',               'Energie Abgabe'],
        'B_HeizenEnergie'           => ['Energie Heizen',                       VARIABLETYPE_FLOAT,   'BHP.kWh',           false, 'nrgHeat',             'Energie Abgabe'],
        'B_KuehlenEnergie'          => ['Energie Kühlen',                       VARIABLETYPE_FLOAT,   'BHP.kWh',           false, 'nrgCool',             'Energie Abgabe'],
        ...
        'B_VerbrauchKompKuehlen'    => ['Verbrauch Kompressor Kühlen',          VARIABLETYPE_FLOAT,   'BHP.kWh',           false, 'nrgConsumCool',       'Energie Verbrauch'],
        ...
        'B_WWKGewaehltTemp'         => ['WWK gewählte Temperatur',              VARIABLETYPE_FLOAT,   '~Temperature',      true,  'wWSelTemp',           'Warmwasser'],
        'B_WWKUntereTemp'           => ['WWK ausgewählte untere Temperatur',    VARIABLETYPE_FLOAT,   '~Temperature',      true,  'wWSelLowerTemp',      'Warmwasser'],
        'B_WWKECO_PlusTemp'         => ['WWK ausgewählte ECO+ Temperatur',      VARIABLETYPE_FLOAT,   '~Temperature',      true,  'wWSelEcoTemp',        'Warmwasser'],
        ...
        'B_WWKHeizstabLimit'        => ['WWK Heizstab Limit für WW',           VARIABLETYPE_INTEGER, 'BHP.HeaterPower',   true,  'wWMaxPower',          'Warmwasser'],
        ...
        'B_ZusatzVerzoegert'        => ['Zusatzheizer verzögert ein',           VARIABLETYPE_INTEGER, 'BHP.Kmin',          true,  'auxDelayTime',        'Zusatzheizer'],
        ...
        'B_SilentMinAussen'         => ['Minimale Außentemp. Silentmodus',     VARIABLETYPE_FLOAT,   '~Temperature',      true,  'silentModeMinExt',    'WP Steuerung'],
        'B_PrimaererWPModus'        => ['Primärer WP-Modus',                   VARIABLETYPE_INTEGER, 'BHP.PrimaryMode',   true,  'hpMode',              'WP Steuerung'],
        'B_KuehlenNurPV'            => ['Kühlen nur mit PV',                   VARIABLETYPE_BOOLEAN, '~Switch',           true,  'pvCooling',           'WP Steuerung'],
        'B_TempDiffHeizen'          => ['Temp.diff. TC3/TC0 Heizen',           VARIABLETYPE_FLOAT,   '~Temperature.1',    true,  'hpTcDiffHeat',        'WP Steuerung'],
        'B_TempDiffKuehlen'         => ['Temp.diff. TC3/TC0 Kühlen',           VARIABLETYPE_FLOAT,   '~Temperature.1',    true,  'hpTcDiffCool',        'WP Steuerung'],
        'B_VentilKuehlen'           => ['Ventil/Pumpe für Kühlen',             VARIABLETYPE_BOOLEAN, '~Switch',           true,  'coolValve',           'WP Steuerung'],
        ...
        // --- Eingänge ---
        'B_StatusEingang1'          => ['Status Eingang 1',                     VARIABLETYPE_BOOLEAN, '~Switch',           false, 'in1',                 'Eingänge'],
        'B_EinstellungEingang1'     => ['Einstellung Eingang 1',                VARIABLETYPE_STRING,  '',                  true,  'in1Set',              'Eingänge'],
        'B_StatusEingang2'          => ['Status Eingang 2',                     VARIABLETYPE_BOOLEAN, '~Switch',           false, 'in2',                 'Eingänge'],
        'B_EinstellungEingang2'     => ['Einstellung Eingang 2',                VARIABLETYPE_STRING,  '',                  true,  'in2Set',              'Eingänge'],
        'B_StatusEingang3'          => ['Status Eingang 3',                     VARIABLETYPE_BOOLEAN, '~Switch',           false, 'in3',                 'Eingänge'],
        'B_EinstellungEingang3'     => ['Einstellung Eingang 3',                VARIABLETYPE_STRING,  '',                  true,  'in3Set',              'Eingänge'],
        'B_StatusEingang4'          => ['Status Eingang 4',                     VARIABLETYPE_BOOLEAN, '~Switch',           false, 'in4',                 'Eingänge'],
        'B_EinstellungEingang4'     => ['Einstellung Eingang 4',                VARIABLETYPE_STRING,  '',                  true,  'in4Set',              'Eingänge'],
    ];

    // =========================================================================
    // Alle Thermostat-Entitäten
    // =========================================================================
    const THERMOSTAT_ENTITIES = [
        ...
        'T_Gebaeudetyp'             => ['Gebäudetyp',                          VARIABLETYPE_INTEGER, 'BHP.Gebaeudetyp',   true,  'building',            'System'],
        'T_MinAussentemperatur'     => ['Min. Außentemperatur',                 VARIABLETYPE_FLOAT,   '~Temperature',      true,  'minexttemp',          'System'],
        'T_DaempfungAussen'         => ['Dämpfung Außentemperatur',             VARIABLETYPE_BOOLEAN, '~Switch',           true,  'damping',             'System'],
        'T_Solar'                   => ['Solar',                                VARIABLETYPE_BOOLEAN, '~Switch',           true,  'solar',               'System'],
        'T_EnergieKostenVerh'       => ['Energie-/Kostenverhältnis',            VARIABLETYPE_INTEGER, '',                  true,  'hp2000Cost',          'System'],
        'T_Abwesend'                => ['Abwesend',                             VARIABLETYPE_BOOLEAN, '~Switch',           true,  'absent',              'System'],
        'T_GedaempfteAussen'        => ['Gedämpfte Außentemperatur',            VARIABLETYPE_FLOAT,   '~Temperature',      false, 'dampedoutdoortemp',   'System'],
        ...
        'T_AbsenkungKuehlenPV'      => ['Absenkung Kühlen mit PV',              VARIABLETYPE_FLOAT,   '~Temperature.1',    true,  'coolPvLower',         'PV Integration'],

        // --- HK1 Grundeinstellungen ---
        ...
        // --- HK1 Temperaturen ---
        'T_HK1GewaehltRaumTemp'     => ['HK1 gewählte Raumtemperatur',          VARIABLETYPE_FLOAT,   '~Temperature',      true,  'hc1seltemp',          'HK1 Temperaturen'],
        ...
        'T_HK1Kuehltemperatur'      => ['HK1 Kühltemperatur',                   VARIABLETYPE_FLOAT,   '~Temperature',      true,  'hc1cooltemp',         'HK1 Temperaturen'],
        ...
        'T_HK1WPKuehlen'            => ['HK1 WP Kühlen',                        VARIABLETYPE_BOOLEAN, '~Switch',           true,  'hc1hpcooling',        'HK1 Optimierung'],
        'T_HK1KuehlungAn'           => ['HK1 Kühlung an',                       VARIABLETYPE_BOOLEAN, '~Switch',           false, 'hc1cooling',          'HK1 Optimierung'],
        ...
        'T_WWKTaeglHeizen'          => ['WWK täglich Heizen',                   VARIABLETYPE_BOOLEAN, '~Switch',           true,  'wwdailyheating',      'WWK Thermostat'],
        'T_WWKTaeglHeizzeit'        => ['WWK tägliche Heizzeit',               VARIABLETYPE_INTEGER, 'BHP.Minutes',       true,  'wwdailyheatingtime',  'WWK Thermostat'],
    ];
    ...
    public function ApplyChanges()
    {
        ...
        if ($this->ReadPropertyBoolean('EnableBoiler'))     $this->CreateAllVariables(self::BOILER_ENTITIES,     'Kessel & Wärmepumpe');
    ...
    {
        // Baue Reverse-Map: emsKey (lowercase) => Ident
        $keyMap = [];
    ...
    private function SetVar(string $ident, $value, int $type): void
    {
    ...
    // =========================================================================
    // RequestAction (WebFront / Skripte)
    // =========================================================================

    public function RequestAction($Ident, $Value)
    {
        // Prüfen ob in Boiler oder Thermostat
        $device = null;
        $emsKey = null;
        ...
        if (!$device || !$emsKey) throw new Exception("Kein schreibbarer EMS-Key für: $Ident");
    ...
    private function SendMQTT(string $device, string $command, $value): void
    {
        $prefix = $this->ReadPropertyString('TopicPrefix');
        ...
        $this->LogMessage("MQTT → $topic : $payload", KL_DEBUG);
    }
    ...
    // =========================================================================
    // Variablen anlegen – mit Kategorien als Unterordner
    // =========================================================================

    private function CreateAllVariables(array $entities, string $deviceName): void
    {
        // Haupt-Kategorie für das Gerät
        ...
        foreach ($entities as $ident => $def) {
            ...
            if (!$varID) {
                ...
                // Variable in die richtige Kategorie verschieben
    ...
    public function SetupVariables(): void
    {
        ...
        echo "✓ $total Variablen angelegt!\n";
        echo "Boiler: " . count(self::BOILER_ENTITIES) . " | Thermostat: " . count(self::THERMOSTAT_ENTITIES) . "\n";
    }
    ...
    {
        $fp = function(string $n, int $t, string $ic, string $sfx, float $mn, float $mx, float $st, int $dg) {
        ...
        $this->CreateEnumProfile('BHP.SilentMode',   VARIABLETYPE_INTEGER, [
            [0,'Aus','',0x888888],[1,'Auto','',0x0066CC],[2,'An','',0x00AA44]]);
        $this->CreateEnumProfile('BHP.PrimaryMode',  VARIABLETYPE_INTEGER, [
            [0,'Auto','',0x0066CC],[1,'Kontinuierlich','',0xFF6600]]);
        $this->CreateEnumProfile('BHP.HeaterPower',  VARIABLETYPE_INTEGER, [
            [0,'0 kW','',0x888888],[2,'2 kW','',0xFFAA00],[3,'3 kW','',0xFF8800],
            [4,'4 kW','',0xFF6600],[6,'6 kW','',0xFF4400],[9,'9 kW','',0xFF0000]]);
        $this->CreateEnumProfile('BHP.OperatingMode',VARIABLETYPE_INTEGER, [
            [0,'Aus','',0x888888],[1,'Manuell','',0xFF6600],[2,'Auto','',0x00AA44]]);
        $this->CreateEnumProfile('BHP.HPMode',       VARIABLETYPE_INTEGER, [
            [0,'Heizen','',0xFF4400],[1,'Kühlen','',0x0066CC],[2,'Heizen & Kühlen','',0x9900CC]]);
        $this->CreateEnumProfile('BHP.DHWMode',      VARIABLETYPE_INTEGER, [
            [0,'Aus','',0x888888],[1,'Eco+','',0x00CC66],[2,'Eco','',0x00AA44],
            [3,'Komfort','',0xFF6600],[4,'Auto','',0x0066CC]]);
        $this->CreateEnumProfile('BHP.CircMode',     VARIABLETYPE_INTEGER, [
            [0,'Aus','',0x888888],[1,'1x3 min','',0xAACC00],[2,'2x3 min','',0x88CC00],
            [3,'3x3 min','',0x66BB00],[4,'4x3 min','',0x44AA00],[5,'5x3 min','',0x229900],
            [6,'6x3 min','',0x008800],[7,'Kontinuierlich','',0xFF6600]]);
        $this->CreateEnumProfile('BHP.CircModeTH',   VARIABLETYPE_INTEGER, [
            [0,'Aus','',0x888888],[1,'An','',0x00AA44],[2,'Auto','',0x0066CC],[3,'Eigenprog.','',0xFF6600]]);
        $this->CreateEnumProfile('BHP.AuxMode',      VARIABLETYPE_INTEGER, [
            [0,'Eco','',0x00AA44],[1,'Komfort','',0xFF6600]]);
        $this->CreateEnumProfile('BHP.WWKComfort',   VARIABLETYPE_INTEGER, [
            [0,'Eco','',0x00AA44],[1,'Gehobener Komfort','',0xFF6600]]);
        $this->CreateEnumProfile('BHP.Gebaeudetyp',  VARIABLETYPE_INTEGER, [
            [0,'Leicht','',0x66AAFF],[1,'Mittel','',0xFFAA00],[2,'Schwer','',0xFF4400]]);
        $this->CreateEnumProfile('BHP.Heizungstyp',  VARIABLETYPE_INTEGER, [
            [0,'Aus','',0x888888],[1,'Heizkörper','',0xFF6600],[2,'Konvektor','',0xFFAA00],[3,'Fußboden','',0x00AA44]]);
        $this->CreateEnumProfile('BHP.SommerModus',  VARIABLETYPE_INTEGER, [
            [0,'Sommer','',0xFFDD00],[1,'Auto','',0x0066CC],[2,'Winter','',0x4488FF]]);
        $this->CreateEnumProfile('BHP.Absenkmodus',  VARIABLETYPE_INTEGER, [
            [0,'Außen','',0x4488FF],[1,'Raum','',0xFF6600],[2,'Reduziert','',0x888888]]);
        $this->CreateEnumProfile('BHP.Frostmodus',   VARIABLETYPE_INTEGER, [
            [0,'Raum','',0xFF6600],[1,'Außen','',0x4488FF],[2,'Raum + Außen','',0x9900CC]]);
        $this->CreateEnumProfile('BHP.Steuermodus',  VARIABLETYPE_INTEGER, [
            [0,'Wetter kompensiert','',0x0066CC],[1,'Basispunkt Außentemp.','',0xFF6600],
            [2,'n/a','',0x888888],[3,'Raum','',0x00AA44],[4,'Leistung','',0xFFAA00],[5,'Konstant','',0xFF4400]]);
        $this->CreateEnumProfile('BHP.Programm',     VARIABLETYPE_INTEGER, [
            [0,'Prog 1','',0x0066CC],[1,'Prog 2','',0xFF6600]]);
        $this->CreateEnumProfile('BHP.SchaltModus',  VARIABLETYPE_INTEGER, [
            [0,'Level','',0x0066CC],[1,'Absolut','',0xFF6600]]);
        $this->CreateEnumProfile('BHP.Wochentag',    VARIABLETYPE_INTEGER, [
            [0,'Mo','',0x0066CC],[1,'Di','',0x0066CC],[2,'Mi','',0x0066CC],[3,'Do','',0x0066CC],
            [4,'Fr','',0x0066CC],[5,'Sa','',0xFF6600],[6,'So','',0xFF4400],[7,'Alle','',0x00AA44]]);
    }
    ...
    public function ProcessHookData(): void
    {
        ...
        // JSON-API Endpunkt für das Dashboard
    ...
    /**
     * Alle Variablenwerte als assoziatives Array zurückgeben
     * (für JSON API des Dashboards)
     */
    private function GetAllValues(): array
    {
        ...
        // Enum-String-Maps für lesbare Werte
        $enumMaps = [
            'B_Silentmodus'       => [0=>'Aus',   1=>'Auto',    2=>'An'],
            'B_PrimaererWPModus'  => [0=>'Auto',  1=>'Kontinuierlich'],
            'B_HeizstabLeistung'  => [0=>'0 kW',  2=>'2 kW',   3=>'3 kW', 4=>'4 kW', 6=>'6 kW', 9=>'9 kW'],
            'B_HeizstabKompressor'=> [0=>'0 kW',  2=>'2 kW',   3=>'3 kW', 4=>'4 kW', 6=>'6 kW', 9=>'9 kW'],
            'B_WWKZirkModus'      => [0=>'Aus', 1=>'1x3min', 2=>'2x3min', 3=>'3x3min', 4=>'4x3min', 5=>'5x3min', 6=>'6x3min', 7=>'Kontinuierlich'],
            'B_ZusatzheizungsModus'=> [0=>'Eco', 1=>'Komfort'],
            'T_HK1Betriebsart'   => [0=>'Aus',   1=>'Manuell', 2=>'Auto'],
            'T_HK1WPModus'       => [0=>'Heizen', 1=>'Kühlen', 2=>'Heizen & Kühlen'],
            'T_WWKBetriebsart'   => [0=>'Aus', 1=>'Eco+', 2=>'Eco', 3=>'Komfort', 4=>'Auto'],
            'T_WWKZirkModus'     => [0=>'Aus', 1=>'An', 2=>'Auto', 3=>'Eigenprog.'],
        ];
        ...
        foreach ($allEntities as $ident => $def) {
            ...
            $type = $def[1];
            switch ($type) {
                case VARIABLETYPE_BOOLEAN: $val = GetValueBoolean($id); break;
                case VARIABLETYPE_INTEGER: $val = GetValueInteger($id); break;
                case VARIABLETYPE_FLOAT:   $val = GetValueFloat($id);   break;
                default:                   $val = GetValueString($id);  break;
            }

            $result[$ident] = $val;

            // Zusätzlich String-Repräsentation für Enum-Werte
    ...
    /**
     * WebHook registrieren (wird bei ApplyChanges aufgerufen)
     */
    private function RegisterWebHook(): void
    {
        ...
        // Prüfen ob WebHook schon registriert
        $ids = IPS_GetInstanceListByModuleID('{015A6EB8-D6E5-4B93-B496-0D3F77AE9FE1}');
        foreach ($ids as $id) {
            $hooks = json_decode(IPS_GetProperty($id, 'Hooks'), true);
            if (is_array($hooks)) {
                foreach ($hooks as $hook) {
                    if ($hook['Hook'] === $hookPath) return; // bereits registriert
                }
            }
        }

        // WebHook Server Instanz finden und Hook registrieren
        if (!empty($ids)) {
            $whID  = $ids[0];
            ...
            $this->LogMessage('WebHook registriert: ' . $hookPath, KL_MESSAGE);
        }
    }
}
